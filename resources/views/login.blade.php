    ...
    <main class="form-signin w-100 m-auto">
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="form-floating">
                ...
                <x-form.input-feedback name="email" />
            </div>
            <div class="form-floating">
                <input type="password" name="password" @class(['form-control', 'is-invalid' => $errors->has('password')]) id="floatingPassword"
                    placeholder="Password">
                <label for="floatingPassword">Password</label>
                <x-form.input-feedback name="password" />
            </div>
